...
describe "ruby" do
  ...
  it 'has methods' do
    ...
    class Object
      def defined_method # define a method named "defined_method"
      end # within this class.
    end
  ...
  it 'has methods that can accept multiple arguments' do
    class Object
      def a_method_with (a, b)# define a method named "a_method_with" that takes two arguments
      end# within this class.
    end
